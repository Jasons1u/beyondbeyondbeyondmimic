...
class _OnnxMotionPolicyExporter(_OnnxPolicyExporter):
    def __init__(self, env: ManagerBasedRLEnv, actor_critic, normalizer=None, verbose=False):
        ...
        self.body_pos_w = motion_source.body_pos_w.to("cpu")
        self.body_quat_w = motion_source.body_quat_w.to("cpu")
        self.body_lin_vel_w = motion_source.body_lin_vel_w.to("cpu")
        self.body_ang_vel_w = motion_source.body_ang_vel_w.to("cpu")
