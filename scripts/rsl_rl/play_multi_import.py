...
parser.add_argument("--registry_name", type=str, default=None, help="The name of the wandb registries (comma-separated).")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    if args_cli.wandb_path:
        ...
        if args_cli.registry_name is not None:
            # Load multiple motion files from wandb registries
            registry_names = args_cli.registry_name.split(",")
            motion_files = []
